...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate that the user is between 0 and 64
    if age is not None:
        age = parse_int(
                age
        )  # Since parameters are strings it's important to cast valuesage
        if age > 64 or age < 0:
            return build_validation_result(
                False,
                "age",
                "The maximum age to use this service is 64 years old. " 
    ...
    if investment_amount is not None:
        ...
        if investment_amount <= 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount is $5,000USD, could "
                "you please provide a greater amount?",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Determines the appropiate portfolio given a customers risk tolerance.
